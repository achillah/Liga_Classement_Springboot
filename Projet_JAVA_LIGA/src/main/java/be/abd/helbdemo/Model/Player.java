...
public class Player implements Serializable {
    ...
    public Player(Long id, String firstnameJoueur, String lastnameJoueur, String posteJoueur, String clubactuelleJoueur, int nbrbutsJoueur, int ageJoueur, Team equipe) {
        Id = id;
